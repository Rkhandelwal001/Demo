	...
	if(isset($_POST['update']))
     {
         ...
         $update = "UPDATE tbl_registration SET first_name='$firstName', last_name='$lastName', email='$email', phone='$phone', country_id='$country', state_id='$state', city='$city', image='$target_file' WHERE id='$Id'";
...
?>
<h2>Update Form</h2>                        
<form action="#" method="post" class="registration">      <!--Edit form-->
